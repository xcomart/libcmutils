...
extern CMUTIL_Bool CMUTIL_PatternIsValid(const char *pat);
extern CMUTIL_Bool CMUTIL_PatternMatch(const char *pat, const char *fname);
extern CMUTIL_Bool CMUTIL_PatternMatchN(const char *pat, const char *fname);
